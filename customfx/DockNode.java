 ...
 * @since DockFX 0.1
 */
public class DockNode extends VBox implements EventHandler<MouseEvent>, Serializable {
	private static final long serialVersionUID = -7763904429470365250L;
	/**
	...
	public DockNode(Node contents, Window node, DockTitleBar dockTitleBar, LayoutNode layoutNode) {
		this(contents, null, null, node, dockTitleBar, layoutNode);
	}
	
	public DockNode(Node contents, String title, Node graphic, Window window, DockTitleBar dockTitleBar, LayoutNode layoutNode) {
	 ...
	 *        title bar and stage.
	 */
	public DockNode(Node contents, String title, DockTitleBar dockTitleBar) {
		this(contents, title, null, null, dockTitleBar, null);
	}
	 ...
	 * @param contents The contents of the dock node which may be a tree or another scene graph node.
	 */
	public DockNode(Node contents, DockTitleBar dockTitleBar, LayoutNode layoutNode) {
		this(contents, null, null, null, dockTitleBar, layoutNode);
	}
	
	public DockNode(Node contents, DockTitleBar dockTitleBar) {
		this(contents, null, null, null, dockTitleBar, null);
	}
	 ...
	 */
	public void setFloating(boolean floating, Point2D translation, Window customOwner) {
		if (floating && !this.isFloating()) {
			...
			if(customOwner != null) {
				stage.initOwner(customOwner);
			} else if (dockPane != null && dockPane.getScene() != null
	...
	public void setFloating(boolean floating) {
		setFloating(floating, null, null);
	}
	
	public void setFloating(boolean floating, Window customOwner) {
		setFloating(floating, null, customOwner);
	}
	 ...
	 */
	public void dock(DockPane dockPane, DockPos dockPos, Node sibling, boolean isCalledByindicatorButton, DockPanePosition dockPanePosition) {
		dockImpl(dockPane);
		dockPane.dock(this, dockPos, sibling, isCalledByindicatorButton, dockPanePosition);
	}
	
	public void dock(DockPane dockPane, DockPos dockPos, Node sibling, boolean isCalledByindicatorButton) {
		dockImpl(dockPane);
		dockPane.dock(this, dockPos, sibling, isCalledByindicatorButton, null);
	}
	 ...
	 * @param dockPos The docking position relative to the sibling of the dock pane.
	 */
	public void dock(DockPane dockPane, DockPos dockPos, boolean isCalledByindicatorButton, DockPanePosition dockPanePosition) {
		dockImpl(dockPane);
		dockPane.dock(this, dockPos, isCalledByindicatorButton, dockPanePosition);
	}
	
	public void dock(DockPane dockPane, DockPos dockPos, boolean isCalledByindicatorButton) {
		dockImpl(dockPane);
		dockPane.dock(this, dockPos, isCalledByindicatorButton, null);
	}
